    ...
    <div id="id02" class="modal">  <!--REGISTER MODAL-->
        ...
        <form class="modal-content animate" action="confirm.php" method="post">
            ...
            <div class="container" style="background-color:#f1f1f1">
                ...
                <input type="submit"  id="savebtn" value="Create user">
            </div>
        </form>
    </div>
</div>
...
<div id="modal" class="hidden">  <!--modalin tapainen aukeaa samalle sivulle huom class hidden-->
    ...
    <form id="palautelomake" action="php/haeArvostelut.php" method="get"> <!--action="haeArvostelut.php": haetaan datat ja lisätään tietokantaan-->
        <!--<p>Nickname:</p>
